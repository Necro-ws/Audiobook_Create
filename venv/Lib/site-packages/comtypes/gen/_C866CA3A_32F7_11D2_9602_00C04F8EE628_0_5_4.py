...
__all__ = [
    'SPRULE', 'SPCT_SLEEP', 'SAFT48kHz8BitMono', 'DISPID_SLWLangId',
    'DISPID_SLWsCount', 'DISPID_SLPType', 'ISpPhoneConverter',
    ...
    'SDA_No_Trailing_Space', 'DISPID_SpeechVoiceStatus',
    'DISPID_SAEventHandle', 'SGDSInactive',
    'SpeechPropertyResourceUsage', 'SPEI_END_INPUT_STREAM',
    'SITooSlow', 'SpeechSpecialTransitionType',
    'DISPID_SVSLastStreamNumberQueued',
    'SSSPTRelativeToCurrentPosition', 'SpeechLoadOption',
    'ISpeechRecoGrammar', 'SVSFParseAutodetect', 'SPRST_INACTIVE',
    'SpeechRunState', 'SPEI_TTS_BOOKMARK',
    'DISPID_SpeechRecoResultTimes', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SAFT16kHz16BitStereo', 'ISpVoice', 'eLEXTYPE_PRIVATE4',
    'DISPID_SDKSetBinaryValue',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SpPhraseInfoBuilder',
    'DISPID_SLWWord', 'SSTTWildcard', 'SDKLCurrentConfig',
    'SpeechInterference', 'SAFTADPCM_8kHzStereo', 'SPLEXICONTYPE',
    'ISpEventSource', 'DISPID_SVSPhonemeId',
    ...
    'STCInprocServer', 'ISpeechDataKey', 'SpVoice',
    'SAFT22kHz8BitMono', 'eLEXTYPE_PRIVATE14', 'SPEI_MIN_TTS',
    'DISPID_SLWs_NewEnum', 'SPPS_NotOverriden',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE11', 'SPWT_LEXICAL', 'SGRSTTRule',
    'DISPID_SPIEngineId', 'SPFM_NUM_MODES', 'SpeechAudioState',
    'SPINTERFERENCE_LATENCY_WARNING', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCEEndStream', 'ISpeechFileStream', 'SREHypothesis',
    'SAFT32kHz8BitMono', 'SLTUser', 'SpSharedRecoContext',
    ...
    'ISpeechPhraseElements', 'SpeechCategoryPhoneConverters',
    'SpeechGrammarTagWildcard', 'SPEI_WORD_BOUNDARY',
    'SpeechDiscardType', 'DISPID_SpeechBaseStream',
    'DISPID_SpeechPhoneConverter', 'DISPID_SWFEExtraData',
    'SPCT_DICTATION', 'ISpLexicon', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SPIReplacements', 'IEnumString', 'ISpeechLexiconWord',
    'DISPID_SVEPhoneme', 'DISPID_SRCERecognition', 'SASStop',
    'DISPID_SPPs_NewEnum', 'SAFT11kHz8BitStereo',
    'SAFTCCITT_uLaw_11kHzMono', 'SDA_Two_Trailing_Spaces', 'SVP_2',
    'SPGS_EXCLUSIVE', 'DISPID_SOTs_NewEnum', 'SRAImport',
    'DISPID_SRStatus', 'SPRS_INACTIVE', 'SpeechEmulationCompareFlags',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPVPRI_OVER',
    'DISPID_SRGState', 'DISPID_SOTCEnumerateTokens', 'SINoise',
    'DISPID_SVEBookmark', 'DISPID_SPPId', 'ISpeechLexicon',
    'DISPID_SLGenerationId', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechObjectToken', 'DISPID_SRCERequestUI',
    'ISpeechXMLRecoResult', 'SpeechEngineConfidence',
    'DISPIDSPTSI_ActiveOffset', 'DISPID_SpeechGrammarRules',
    'DISPID_SVSpeak', 'SDTDisplayText', 'DISPID_SRCEBookmark',
    'SRERecoOtherContext', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechPhraseElements', 'DISPID_SLWType',
    'DISPID_SMSSetData', 'SVEWordBoundary', 'SP_VISEME_11',
    'SPXMLRESULTOPTIONS', 'SPEI_SR_AUDIO_LEVEL',
    'SREFalseRecognition', 'DISPID_SPEsCount',
    'DISPID_SpeechObjectTokens', 'SAFTCCITT_uLaw_11kHzStereo',
    'ISpeechAudioBufferInfo', 'SGRSTTWord', 'ISpObjectToken',
    'SGSEnabled', 'eLEXTYPE_PRIVATE6', 'eLEXTYPE_PRIVATE13',
    'SPRST_NUM_STATES', 'SP_VISEME_12', 'ISpeechLexiconWords',
    'SPPS_RESERVED2', 'SPLOADOPTIONS', 'DISPID_SPIGetText',
    'SSFMOpenReadWrite', 'DISPID_SpeechGrammarRule', 'DISPID_SBSSeek',
    'ISpeechObjectTokenCategory', 'SAFTCCITT_uLaw_8kHzMono',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SDKGetStringValue',
    'SVEVoiceChange', 'SVEViseme', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SPIGetDisplayAttributes', 'SpNullPhoneConverter',
    'STSF_AppData', 'SpAudioFormat',
    'DISPID_SGRSAddSpecialTransition', 'ISpRecognizer3',
    'SPPS_Function', 'SPFM_OPEN_READONLY',
    'DISPID_SPRuleFirstElement', 'DISPID_SRSAudioStatus',
    'DISPID_SVEWord', 'SPSERIALIZEDPHRASE', 'ISpShortcut',
    'DISPID_SRGetRecognizers', 'DISPIDSPTSI',
    'SWPUnknownWordUnpronounceable', 'SP_VISEME_21',
    'ISpeechPhraseInfo', 'ISpeechCustomStream', 'SPSHT_OTHER',
    ...
    'SPVPRI_ALERT', 'SGRSTTTextBuffer', 'DISPID_SOTCreateInstance',
    'DISPID_SBSWrite', 'DISPID_SPEDisplayAttributes', 'SpMMAudioOut',
    'SpInProcRecoContext', 'DISPID_SABIEventBias', 'DISPID_SRRAudio',
    'SPBO_PAUSE', 'DISPID_SPELexicalForm', 'DISPID_SLPPhoneIds',
    'ISpeechGrammarRuleState', 'SPPS_Noncontent',
    'SpeechDictationTopicSpelling', 'DISPID_SOTMatchesAttributes',
    'DISPID_SpeechVoiceEvent', 'DISPID_SRCEStartStream',
    'DISPID_SpeechPhraseInfo', 'SPDKL_DefaultLocation',
    'DISPID_SRGetPropertyNumber', 'SAFTText', 'DISPID_SRGetFormat',
    'SPINTERFERENCE_TOOLOUD', 'SPEI_START_INPUT_STREAM',
    'DISPID_SOTGetDescription', 'DISPID_SGRSTWeight',
    'SpeechGrammarTagDictation', 'DISPID_SREmulateRecognition',
    'SpPhoneConverter', 'SpInprocRecognizer',
    ...
    'DISPID_SRCPause', 'SPWORDLIST', 'DISPID_SVVoice', 'SVSFDefault',
    ...
    'SVSFlagsAsync', 'ISpResourceManager', 'SPEI_UNDEFINED',
    'STSF_LocalAppData', 'ISpeechMMSysAudio', 'SPAS_PAUSE',
    'SPAUDIOSTATUS', 'SPCS_DISABLED', 'SPSHORTCUTPAIR',
    'DISPID_SpeechPhraseReplacements', 'SPSUnknown', 'SPRS_ACTIVE',
    'SAFTCCITT_uLaw_8kHzStereo', 'SpeechFormatType',
    'DISPID_SRProfile', 'SSFMCreateForWrite', 'SPBOOKMARKOPTIONS',
    ...
    'SPWT_DISPLAY', 'DISPID_SRCCmdMaxAlternates', 'SpeechAudioVolume',
    'SAFT44kHz16BitStereo', 'SITooFast', 'ISpeechBaseStream',
    'SSTTDictation', 'eLEXTYPE_PRIVATE20', 'SVEAudioLevel',
    'SP_VISEME_17', 'ISpeechPhraseReplacements', 'SPAR_Low',
    'DISPID_SPIRule', 'SAFT8kHz8BitMono',
    'DISPID_SRCERecognizerStateChange', 'SpeechTokenKeyAttributes',
    'SAFTDefault', 'DISPID_SDKSetStringValue',
    'DISPID_SGRSTransitions', 'SRSInactiveWithPurge',
    'SpeechPropertyHighConfidenceThreshold', 'SpeechRecoEvents',
    'SpeechAudioFormatGUIDWave', 'SPPS_Noun', 'eLEXTYPE_RESERVED9',
    'SVP_16', 'DISPID_SpeechCustomStream', 'DISPID_SOTsItem',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SRDisplayUI',
    'SAFTADPCM_8kHzMono', 'SVF_Stressed', 'SpWaveFormatEx',
    'DISPID_SVStatus', 'DISPID_SRRAlternates', 'SP_VISEME_20',
    'SPBO_NONE', 'eLEXTYPE_PRIVATE18', 'SSFMOpenForRead',
    'ISpeechResourceLoader', 'DISPID_SPRulesCount',
    'DISPID_SVSVisemeId', 'SPRST_INACTIVE_WITH_PURGE',
    'SAFT32kHz16BitMono', 'SFTSREngine', 'DISPID_SPPEngineConfidence',
    'SSTTTextBuffer', 'SVSFNLPMask', 'SVSFIsXML', 'SVPAlert',
    'DISPID_SVRate', 'SAFTCCITT_ALaw_44kHzStereo', 'SRTEmulated',
    'eLEXTYPE_PRIVATE5', 'SPFM_CREATE', 'SVP_3', 'SBOPause',
    'DISPID_SpeechRecoContext', 'DISPID_SPILanguageId',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'DISPID_SVSLastBookmark',
    'DISPID_SPPFirstElement', 'DISPID_SRCESoundStart',
    'eLEXTYPE_PRIVATE9', 'DISPID_SOTRemoveStorageFileName',
    'DISPID_SGRAddResource', 'ISpeechPhraseReplacement',
    ...
    'DISPID_SPCIdToPhone', 'ISpeechObjectTokens', 'DISPID_SLPsCount',
    'SVF_None', 'SAFT48kHz16BitStereo', 'DISPID_SVResume',
    'SP_VISEME_16', 'SPWT_PRONUNCIATION', 'DISPID_SGRSTPropertyName',
    'tagSPTEXTSELECTIONINFO', 'DISPID_SOTsCount', 'SRAONone',
    'eLEXTYPE_MORPHOLOGY', 'ISpeechRecoResult2', 'SVP_11',
    'SAFTGSM610_11kHzMono', 'SpeechWordType', 'SDTRule', 'SGDisplay',
    'SSFMCreate', 'DISPID_SpeechPhraseAlternates', 'ISpMMSysAudio',
    'SPEI_SOUND_END', 'SPPS_RESERVED4', 'SPGS_DISABLED',
    'DISPID_SWFEBlockAlign', 'eLEXTYPE_PRIVATE10',
    ...
    'eLEXTYPE_PRIVATE1', 'SVP_7', 'SPEI_RECOGNITION',
    'eLEXTYPE_PRIVATE17', 'SVP_6', 'SVPOver', 'DISPID_SGRSTType',
    'ISpProperties', 'SAFT11kHz16BitMono', 'SpMemoryStream',
    'SRSActiveAlways', 'SITooQuiet', 'SPRST_ACTIVE',
    'DISPID_SVGetVoices', 'ISpeechPhraseRule', 'DISPID_SLGetWords',
    'SPFM_CREATE_ALWAYS', 'DISPID_SAFGetWaveFormatEx',
    'ISpeechRecoResultDispatch', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SABIBufferSize', 'DISPID_SBSFormat',
    'DISPID_SPRuleNumberOfElements', 'DISPID_SpeechLexiconWords',
    'SRTExtendableParse', 'SITooLoud', 'ISpRecognizer',
    'SAFTCCITT_ALaw_22kHzMono', 'SPAO_RETAIN_AUDIO', 'SP_VISEME_2',
    'SPSMF_SAPI_PROPERTIES', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRGetXMLErrorInfo', 'DISPID_SRCEAdaptation',
    'SECLowConfidence', 'eLEXTYPE_PRIVATE16',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'Speech_StreamPos_RealTime',
    'SPINTERFERENCE_NONE', 'SPINTERFERENCE_NOISE', 'ISpPhraseAlt',
    'IInternetSecurityMgrSite', 'DISPID_SFSClose',
    'SAFTExtendedAudioFormat', 'SECFDefault',
    'DISPID_SASFreeBufferSpace', 'ISpRecoCategory',
    'DISPID_SRIsUISupported', 'SPBO_AHEAD',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'ISpObjectTokenCategory', 'SpeechTokenKeyFiles',
    'SPDKL_LocalMachine', 'DISPID_SRIsShared', 'SP_VISEME_4',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SRCEEnginePrivate',
    'SGDSActiveUserDelimited', 'SGDSActiveWithAutoPause',
    'SPLO_STATIC', 'DISPID_SRSClsidEngine', 'SPEI_PHRASE_START',
    'SAFTCCITT_ALaw_11kHzMono', 'SP_VISEME_10', 'SVF_Emphasis',
    'SpPhoneticAlphabetConverter', 'DISPID_SDKGetlongValue',
    'ISpeechAudioStatus', 'DISPID_SpeechPhraseRule', 'SPPHRASE',
    'DISPID_SOTCId', 'SP_VISEME_9', 'DISPID_SVGetProfiles',
    'SPADAPTATIONRELEVANCE', 'DISPID_SDKOpenKey', 'SREAllEvents',
    'DISPID_SVSpeakStream', 'DISPID_SAVolume',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SVSFIsFilename',
    'SpeechRecoContextState', 'SVSFPersistXML', 'SREPrivate',
    'SRARoot', 'DISPID_SRCEHypothesis', 'DISPID_SVVolume',
    'DISPID_SWFEBitsPerSample', 'SAFT22kHz16BitMono',
    'SPEI_VOICE_CHANGE', 'SRAInterpreter', 'SGRSTTEpsilon',
    'SpeechDisplayAttributes', 'SAFT16kHz16BitMono',
    'DISPID_SPAStartElementInResult', 'SPAO_NONE', 'DISPID_SPPValue',
    'SAFT12kHz16BitStereo', 'STSF_CommonAppData', 'SVSFParseMask',
    'SREAudioLevel', 'SpeechStreamSeekPositionType',
    'DISPID_SLGetPronunciations', 'STSF_FlagCreate',
    'DISPID_SPCLangId', 'SPPARTOFSPEECH', 'SVP_21',
    'DISPID_SABIMinNotification', 'DISPID_SPERetainedSizeBytes',
    'eLEXTYPE_PRIVATE3', 'SpeechTokenIdUserLexicon',
    'DISPID_SAStatus', 'SWTAdded', 'SPEI_MAX_TTS',
    'SpeechVoicePriority', 'ISpRecoContext', 'SVP_13',
    'SRCS_Disabled', 'SpeechTokenKeyUI', 'DISPID_SPIElements',
    'SRTReSent', 'SPEI_TTS_AUDIO_LEVEL', 'SpeechTokenShellFolder',
    'SPDATAKEYLOCATION', 'ISpeechPhraseElement', 'SREStreamStart',
    'ISpeechGrammarRuleStateTransitions', 'SP_VISEME_5',
    'DISPID_SpeechPhraseProperties', 'DISPID_SRAudioInputStream',
    'Speech_StreamPos_Asap', 'SPSHT_NotOverriden', 'SpObjectToken',
    'DISPID_SRGetPropertyString',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechLexiconWord', 'DISPID_SOTRemove', 'SPEVENT',
    'ISpNotifyTranslator', 'DISPID_SRGSetTextSelection',
    'SPWF_SRENGINE', 'SVEEndInputStream', 'SPVPRIORITY',
    'SpeechRecognizerState', 'DISPID_SDKGetBinaryValue', 'SPSVerb',
    'DISPID_SGRsFindRule', 'DISPID_SPIRetainedSizeBytes',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SOTCDefault',
    'DISPID_SOTDataKey', 'SpeechGrammarWordType', 'SINoSignal',
    'SGRSTTWildcard', '_ISpeechRecoContextEvents',
    'DISPID_SPRuleParent', 'SFTInput', 'DISPID_SPACommit',
    'SPCATEGORYTYPE', 'DISPID_SVAudioOutputStream',
    'DISPID_SVSLastBookmarkId', 'DISPID_SPEDisplayText',
    'SGRSTTDictation', 'DISPID_SGRSTText', 'SAFT22kHz8BitStereo',
    'DISPID_SPAsItem', 'SAFT24kHz16BitMono',
    'DISPID_SRCEPropertyNumberChange', 'DISPID_SpeechFileStream',
    'ISpStreamFormatConverter', 'ISpeechObjectToken', 'SPEI_MIN_SR',
    'DISPID_SASCurrentDevicePosition', 'SPXRO_Alternates_SML',
    'DISPID_SPARecoResult', 'SpeechRecoProfileProperties',
    'SAFT48kHz8BitStereo', 'SpeechLexiconType', 'SPEI_INTERFERENCE',
    'ISpeechGrammarRule', 'ISpRecoGrammar', 'DISPID_SOTCGetDataKey',
    ...
    'DISPID_SDKEnumValues', 'SPPS_Verb', 'SREInterference',
    'IEnumSpObjectTokens', 'tagSPPROPERTYINFO', 'SDTAudio',
    'DISPID_SVDisplayUI', 'SAFTADPCM_44kHzStereo',
    'SAFT32kHz16BitStereo', 'DISPID_SGRId', 'SAFT12kHz8BitMono',
    'DISPID_SpeechObjectTokenCategory', 'DISPID_SGRInitialState',
    'SPAS_RUN', 'STCLocalServer', 'DISPID_SPRules_NewEnum',
    'SSSPTRelativeToEnd', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SPPHRASEELEMENT', 'DISPID_SPAsCount', 'DISPID_SRCVoice',
    'SPSLMA', 'DISPID_SRGDictationLoad', 'SRCS_Enabled',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPIEnginePrivateData',
    'SpeechGrammarRuleStateTransitionType', 'SVP_15', 'SP_VISEME_15',
    'DISPID_SVSInputWordLength', 'DISPID_SRGCmdLoadFromFile',
    'SPSHT_EMAIL', 'SREStateChange', 'SVP_12', 'DISPID_SWFEFormatTag',
    'SPWF_INPUT', 'DISPID_SGRName', 'ISpeechPhraseProperties',
    'SPINTERFERENCE', 'SPEI_VISEME', 'ISpRecognizer2',
    'DISPID_SLAddPronunciation', 'DISPID_SWFESamplesPerSec',
    'DISPID_SGRSRule', 'DISPID_SGRsCommit', 'SPEI_HYPOTHESIS',
    'SAFT8kHz8BitStereo', 'SPSSuppressWord', 'SECHighConfidence',
    ...
    'DISPID_SRRRecoContext', 'SPEI_SOUND_START',
    'SAFT16kHz8BitStereo', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGCmdLoadFromResource', 'DISPID_SpeechWaveFormatEx',
    'eLEXTYPE_PRIVATE8', 'DISPID_SVSkip', 'SpeechVisemeFeature',
    'DISPID_SMSALineId', 'DISPID_SRRTLength', 'DISPID_SMSAMMHandle',
    'SPSHORTCUTPAIRLIST', 'DISPID_SRRSpeakAudio', 'SPBO_TIME_UNITS',
    'DISPID_SRAudioInput', 'SpTextSelectionInformation',
    'eLEXTYPE_USER', 'SREBookmark', 'SpFileStream', 'SP_VISEME_13',
    'ISpeechRecoResultTimes', 'SAFT48kHz16BitMono',
    'SPTEXTSELECTIONINFO', 'SVEBookmark', 'DISPID_SOTCategory',
    'STCAll', 'DISPID_SPAs_NewEnum', 'SPAR_Unknown',
    'DISPID_SPRsCount', 'SAFTGSM610_8kHzMono', 'DISPID_SPRuleId',
    'SPEI_START_SR_STREAM', 'DISPID_SVAudioOutput', 'DISPID_SGRsAdd',
    'SREAdaptation', 'DISPID_SLWsItem', 'ISpNotifySource',
    'SpeechGrammarState', 'DISPID_SRCResume',
    'SPEI_FALSE_RECOGNITION', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechRecoResult', 'DISPID_SPRulesItem',
    'SpeechStreamFileMode', 'ISpNotifySink',
    'DISPID_SRSCurrentStreamPosition', 'SpeechCategoryRecognizers',
    'DISPID_SVSInputSentenceLength', 'SDKLCurrentUser',
    'SPWORDPRONOUNCEABLE', 'SPINTERFERENCE_NOSIGNAL',
    'DISPID_SVEventInterests', 'DISPID_SpeechAudio',
    'DISPID_SVWaitUntilDone', 'DISPID_SPPChildren',
    'SpNotifyTranslator', 'SPPS_Unknown', 'SPRECOCONTEXTSTATUS',
    'Speech_Max_Pron_Length', 'SGSExclusive', 'SRAExport',
    'ISpDataKey', 'DISPID_SVEAudioLevel', 'SVP_17', 'SGSDisabled',
    'SPSInterjection', 'DISPID_SVSRunningState',
    'SVEStartInputStream', 'ISpStream', 'ISpRecoResult',
    'SPWORDPRONUNCIATIONLIST', 'DISPID_SMSADeviceId',
    'SPSERIALIZEDRESULT', 'eLEXTYPE_APP', 'ISpeechVoiceStatus',
    'SAFT24kHz8BitMono', '__MIDL_IWinTypes_0009', 'SPPS_RESERVED3',
    'tagSTATSTG', 'DISPID_SVEVoiceChange', 'DISPID_SLPsItem',
    'DISPID_SPCPhoneToId', 'SPAUDIOBUFFERINFO', 'DISPID_SGRsItem',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'SpeechVisemeType',
    'SpObjectTokenCategory', 'DISPID_SVEViseme',
    'DISPID_SpeechRecoResult2', 'ISpeechAudio',
    'SSSPTRelativeToStart', 'SASClosed', 'SDKLLocalMachine',
    'DISPID_SPEActualConfidence',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet', 'SRESoundEnd',
    'SPAUDIOSTATE', 'DISPID_SPPsCount', 'SPSHORTCUTTYPE', 'SPAR_High',
    'ISpPhoneticAlphabetSelection', 'DISPID_SADefaultFormat',
    ...
    'DISPID_SPPName', 'SPPHRASERULE', '_ISpeechVoiceEvents',
    'eLEXTYPE_RESERVED4', 'DISPID_SAFType',
    'SAFTCCITT_uLaw_44kHzStereo', 'ISpGrammarBuilder', 'SVP_9',
    ...
    'SpLexicon', 'SPVISEMES', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SPIGrammarId', 'DISPID_SDKSetLongValue',
    'DISPID_SWFEAvgBytesPerSec', 'SRERequestUI',
    'DISPID_SPRuleConfidence', 'DISPID_SVIsUISupported',
    'SAFTADPCM_22kHzMono', 'SP_VISEME_7',
    'DISPID_SpeechPhraseBuilder', 'SAFT44kHz8BitMono',
    'SpeechPartOfSpeech', 'DISPID_SpeechRecognizerStatus',
    'DISPID_SGRAttributes', 'DISPID_SPPNumberOfElements', 'IStream',
    'DISPID_SPEAudioSizeTime', 'SPPROPERTYINFO',
    'SDA_One_Trailing_Space', 'ISpeechPhraseProperty',
    'DISPID_SPIAudioSizeTime', 'ISpAudio',
    'ISpeechTextSelectionInformation', 'DISPID_SPAPhraseInfo',
    'SpeechCategoryVoices', 'ISpEventSink', 'SPCT_COMMAND', 'SASRun',
    'SWPKnownWordPronounceable', 'SPVPRI_NORMAL',
    'SECNormalConfidence', 'SWTDeleted', 'SDTLexicalForm',
    'SVSFNLPSpeakPunc', 'DISPID_SVSInputWordPosition', 'SpStream',
    '_SPAUDIOSTATE', 'DISPID_SASState', 'SpMMAudioIn',
    'DISPID_SGRSTPropertyValue', 'SpCompressedLexicon',
    'ISpeechLexiconPronunciation', 'DISPIDSPRG',
    'DISPID_SRCEInterference', 'SPPS_LMA', 'eLEXTYPE_RESERVED6',
    'DISPID_SLAddPronunciationByPhoneIds', 'SpeechRuleState',
    'SPFILEMODE', 'DISPID_SpeechPhraseProperty',
    ...
    'SASPause', 'SPAUDIOOPTIONS', 'SVSFPurgeBeforeSpeak',
    'DISPID_SDKDeleteKey', 'SP_VISEME_8', 'SAFT8kHz16BitMono',
    'SVP_4', 'SPSModifier', 'DISPID_SLRemovePronunciation',
    'SpeechDataKeyLocation', 'SPEI_SR_RETAINEDAUDIO', 'SINone',
    'DISPID_SRRecognizer', 'SPSHT_Unknown', 'ISpStreamFormat',
    'SPVOICESTATUS', 'DISPID_SAFSetWaveFormatEx', 'SAFT11kHz8BitMono',
    'SPGRAMMARWORDTYPE', 'DISPID_SRGDictationSetState', 'SDTAll',
    'SPRECOSTATE', 'eWORDTYPE_ADDED', 'DISPID_SRGId',
    'DISPID_SRGRecoContext', 'SVP_8', 'DISPID_SpeechMMSysAudio',
    'DISPID_SCSBaseStream', 'SPEI_PROPERTY_NUM_CHANGE', 'SVEPhoneme',
    'SPGS_ENABLED', 'DISPID_SpeechXMLRecoResult',
    'ISpeechPhraseRules', 'DISPID_SRCEAudioLevel', 'SVP_10',
    'DISPID_SPRuleEngineConfidence', 'SPSNotOverriden', 'SLOStatic',
    'SECFIgnoreWidth', 'SpeechTokenValueCLSID',
    ...
    'SpeechVoiceCategoryTTSRate', 'SPPS_RESERVED1',
    ...
    'SAFTCCITT_ALaw_8kHzMono', 'SPWORDTYPE', 'SPPHRASEPROPERTY',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPIDSPTSI_ActiveLength', 'SpeechAudioFormatType', 'SGDSActive',
    'DISPID_SRGDictationUnload', 'SpeechGrammarTagUnlimitedDictation',
    'SLTApp', 'SPDKL_CurrentUser', 'DISPID_SPPParent',
    'ISpSerializeState', 'SAFTNonStandardFormat',
    'SECFNoSpecialChars', 'SpeechRecognitionType', 'ISpRecoContext2',
    'SVP_5', 'SPEI_PHONEME', 'SPFM_OPEN_READWRITE', 'SVP_18',
    'DISPID_SRState', 'SDTAlternates', 'DISPID_SRCState',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'DISPID_SOTGetAttribute',
    'SPEVENTENUM', 'SDTReplacement', 'eLEXTYPE_RESERVED10',
    'SpeechAllElements', 'DISPID_SRRGetXMLResult',
    'SpeechVoiceSpeakFlags', 'DISPID_SLPPartOfSpeech',
    'eLEXTYPE_RESERVED7', 'SpeechAudioProperties',
    'SPPS_SuppressWord', 'DISPID_SFSOpen', 'ISpeechGrammarRules',
    'SAFT8kHz16BitStereo', 'Speech_Max_Word_Length',
    'DISPID_SPIStartTime', 'DISPID_SpeechVoice', 'SPGRAMMARSTATE',
    'ISpObjectWithToken', 'SPXRO_SML', 'SPCS_ENABLED',
    'DISPID_SPRuleName', 'ISpeechGrammarRuleStateTransition',
    'SAFT24kHz8BitStereo', 'eLEXTYPE_USER_SHORTCUT', 'SP_VISEME_1',
    'SpeechVoiceSkipTypeSentence', 'SpeechWordPronounceable',
    'SPEI_MAX_SR', 'ISpeechPhraseAlternates', 'SRSActive',
    'DISPID_SLWPronunciations', 'SP_VISEME_14', 'SVP_14',
    'DISPID_SASetState', 'SpResourceManager', 'SpeechVoiceEvents',
    'SpMMAudioEnum', 'SPSNoun', 'SpeechEngineProperties',
    'DISPID_SpeechRecoContextEvents', 'SAFT44kHz16BitMono',
    'DISPID_SPISaveToMemory', 'SAFTCCITT_ALaw_22kHzStereo',
    'SPCT_SUB_COMMAND', 'ISpRecoGrammar2',
    'DISPID_SPEEngineConfidence', 'LONG_PTR',
    'DISPID_SpeechPhraseElement', 'SBONone', 'SP_VISEME_18',
    'ISpeechRecoContext', 'DISPID_SOTSetId',
    'SAFTCCITT_ALaw_44kHzMono', 'SREPhraseStart', 'SLODynamic',
    'DISPID_SOTId', 'DISPID_SGRs_NewEnum', 'SECFIgnoreCase',
    'DISPID_SPRNumberOfElements', 'DISPID_SVSLastResult',
    'SRADefaultToActive', 'ISpeechAudioFormat', 'SPAR_Medium',
    'DISPID_SOTIsUISupported', 'SDTPronunciation',
    'SPPHRASEREPLACEMENT', 'DISPID_SVSyncronousSpeakTimeout',
    'DISPID_SPEAudioTimeOffset', 'SRSEDone', 'SPCONTEXTSTATE',
    'SVP_1', 'SVPNormal', 'DISPID_SPERequiredConfidence', 'SVP_19',
    'SVP_20', 'SAFTCCITT_uLaw_44kHzMono', 'SPSEMANTICERRORINFO',
    'SPEI_ADAPTATION', 'SpeechRuleAttributes', 'SVSFUnusedFlags',
    'SRSEIsSpeaking', 'SPEI_TTS_PRIVATE', 'SpeechCategoryAudioOut',
    'DISPID_SRGRules', 'DISPID_SRRSaveToMemory', 'SRERecognition',
    'SAFTCCITT_ALaw_11kHzStereo', 'ISpeechRecoResult',
    ...
    'DISPID_SRRPhraseInfo', 'ISpeechVoice', 'DISPID_SGRSTsCount',
    'SPRECOGNIZERSTATUS', 'SPEI_RESERVED6',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SpeechAudioStatus',
    'SPAS_STOP', 'SPSMF_UPS', 'SAFT11kHz16BitStereo',
    'DISPID_SRGCommit', 'SAFT44kHz8BitStereo', 'SPBINARYGRAMMAR',
    'SWPUnknownWordPronounceable', 'SpUnCompressedLexicon',
    'SVEPrivate', 'DISPID_SpeechDataKey', 'SVESentenceBoundary',
    ...
    'SPEI_SR_BOOKMARK', 'SpShortcut', 'SRESoundStart',
    'SPEI_REQUEST_UI', 'DISPID_SRRTimes', 'DISPID_SWFEChannels',
    'SpeechAddRemoveWord', 'SAFTADPCM_11kHzStereo', 'WAVEFORMATEX',
    'SPWORD', 'eWORDTYPE_DELETED', 'DISPID_SRCRecognizer',
    'DISPID_SGRSTsItem', 'SVP_0', 'SPRECORESULTTIMES',
    'DISPID_SRSetPropertyNumber', 'SPEI_RESERVED2', 'SVEAllEvents',
    'DISPID_SABufferInfo', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRRTStreamTime', 'SPEI_PROPERTY_STRING_CHANGE',
    'SGLexicalNoSpecialChars', 'DISPID_SRCEPhraseStart',
    'ISpeechWaveFormatEx', 'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SP_VISEME_19', 'SPSMF_SRGS_SAPIPROPERTIES',
    'DISPID_SRCEFalseRecognition', 'SPINTERFERENCE_TOOSLOW',
    'ISpeechPhoneConverter', 'DISPID_SGRClear', 'DISPID_SRCESoundEnd',
    'SRADynamic', 'ISpPhrase', 'eLEXTYPE_PRIVATE12',
    'eLEXTYPE_PRIVATE15', '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPID_SVSInputSentencePosition', 'SGLexical',
    'DISPID_SpeechPhraseRules', 'DISPID_SGRAddState', 'SPLO_DYNAMIC',
    'DISPID_SRGIsPronounceable', 'SECFIgnoreKanaType', 'SPSFunction',
    'DISPID_SLPLangId', 'ISpeechPhraseAlternate', 'STCInprocHandler',
    'DISPID_SRCBookmark', 'SAFTTrueSpeech_8kHz1BitMono',
    ...
    'DISPID_SPRsItem', 'DISPID_SMSGetData', 'DISPID_SVEEnginePrivate',
    'SPEI_END_SR_STREAM', 'UINT_PTR', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'SPEI_SR_PRIVATE', 'DISPID_SPIAudioStreamPosition', 'SRATopLevel',
    'SDTProperty', 'DISPID_SRRTTickCount', 'DISPID_SVGetAudioInputs',
    'DISPID_SpeechRecognizer', 'DISPID_SDKCreateKey',
    'DISPID_SVPause', 'DISPID_SPEAudioStreamOffset',
    'DISPID_SDKEnumKeys', 'DISPID_SGRSTNextState', 'SRSInactive',
    ...
    'SPEI_RECO_OTHER_CONTEXT', 'STCRemoteServer', 'DISPID_SPPsItem',
    'SP_VISEME_3', 'eLEXTYPE_PRIVATE19', 'SPSEMANTICFORMAT',
    'SP_VISEME_6', 'DISPID_SPPConfidence', 'DISPID_SPEs_NewEnum',
    'SPAS_CLOSED', 'SpeechPropertyAdaptationOn', 'ISpeechRecognizer',
    'DISPID_SpeechAudioBufferInfo', 'DISPID_SRSCurrentStreamNumber',
    'DISPID_SOTCSetId', 'SP_VISEME_0', 'DISPID_SLPSymbolic',
    'DISPID_SRCRequestedUIType', 'DISPID_SGRSAddWordTransition',
    'SpeechTokenContext', 'DISPID_SpeechPhraseReplacement',
    'SAFT12kHz8BitStereo', 'SPEVENTSOURCEINFO', 'SECFEmulateResult'
]

_check_version('1.2.0', 1697245429.691740)
